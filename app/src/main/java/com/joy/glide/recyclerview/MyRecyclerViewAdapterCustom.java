...
public class MyRecyclerViewAdapterCustom extends RecyclerView.Adapter<MyRecyclerViewAdapterCustom.ViewHolder> {

	private List<String> list;

	public MyRecyclerViewAdapterCustom(List<String> list) {
		this.list = list;
	}
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		...
		MyRecyclerViewAdapterCustom.ViewHolder viewHolder = new MyRecyclerViewAdapterCustom.ViewHolder(view);
		return viewHolder;
	}
	...
	public void onBindViewHolder(ViewHolder holder, int position) {
		...
		test1(holder.imageView,list.get(position),holder.progressBar);
